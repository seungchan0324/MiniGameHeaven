...
public class Babo extends JFrame {
	...
	public Babo() {
		...
		ImageIcon ic = new ImageIcon("±¸¹Ì.png");
		...
		button.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (SwingUtilities.isRightMouseButton(e)) {
					if (cnt == 0) {
						ImageIcon newIcon = new ImageIcon("±¸¹Ì_¿·2.png");
						button.setIcon(newIcon);
					} else if (cnt == 1) {
						ImageIcon newIcon = new ImageIcon("±¸¹Ì_µÚ.png");
						button.setIcon(newIcon);
					} else if (cnt == 2) {
						ImageIcon newIcon = new ImageIcon("±¸¹Ì_¿·.png");
						button.setIcon(newIcon);
					} else if (cnt == 3) {
						ImageIcon newIcon = new ImageIcon("±¸¹Ì.png");
						button.setIcon(newIcon);
						cnt = -1;
					}
				}
