...
public class ClickClickGame extends JFrame {
	...
	public ClickClickGame() {
		...
		breakLabel = new JLabel("알이 더 단단해졌습니다.");
		breakLabel.setFont(new Font("맑은 고딕", Font.BOLD, 21));
		...
		gameLabel.setFont(new Font("맑은 고딕", Font.BOLD, 23));
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (click < clickNeeded) {
					...
					if (click >= clickNeeded) {
						...
						breakLabel.setText("알이 더 단단해졌습니다!!");
